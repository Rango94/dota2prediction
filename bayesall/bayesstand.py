...
fobayes.append(open('bayes1800.txt'))
fobayes.append(open('bayes2100.txt'))
fobayes.append(open('bayes2400.txt'))
fobayes.append(open('bayes2700.txt'))
fobayes.append(open('bayes3000.txt'))
fobayes.append(open('bayes8888.txt'))
bayesall=[]
for j in fobayes:
    bayes = []
    for i in j:
